...
In `results.py`, copy image bytes into new read-only NumPy arrays and recursively copy JSON-native mappings. Accept statuses `PASS`, `PARTIAL`, `NO_TARGETS`, `REJECTED`; for V1-01 use `PASS`. Use ASCII patterns:
